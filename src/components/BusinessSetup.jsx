...
export default function BusinessSetup({ account, business: initialBusiness, onSession, onComplete }) {
  ...
  return <main className="onboarding-shell" ref={rootRef}><header className="onboarding-topbar"><div className="brand-mark"><span className="mark-icon" aria-hidden="true"><span /></span><span>stockroom</span></div></header><div className="onboarding-progress"><span>Step {step} of 7 · {steps[step - 1]}</span><div><i style={{ width: `${step / 7 * 100}%` }} /></div></div><section className="onboarding-card">
